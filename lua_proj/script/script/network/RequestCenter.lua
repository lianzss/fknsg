...
--------------------------------------- ICopy ---------------------------------------- 
--获取普通副本
function getNormalCopyList(cbFunc)
    Network.rpc(cbFunc, "ncopy.getCopyList", "ncopy.getCopyList", nil, true)
end
...
--------------寻龙探宝-------------
-- 地图
function dragonGetMap(fn_cb, params)
    Network.rpc(fn_cb, "dragon.getMap", "dragon.getMap", params, true)
    return "dragon.getMap"
end

-- 移动
function dragonMove(fn_cb, params)
     Network.rpc(fn_cb, "dragon.move", "dragon.move", params, true)
    return "dragon.move"
end

-- 自动寻路 
function dragonAutoMove(fn_cb, params)
    Network.rpc(fn_cb, "dragon.autoMove", "dragon.autoMove", params, true)
    return "dragon.autoMove"
end

-- 自动探宝
function dragonAiDo(fn_cb, params)
    Network.rpc(fn_cb, "dragon.aiDo", "dragon.aiDo", params, true)
    return "dragon.aiDo"
end

-- 重置
function dragonReset(fn_cb, params)
    Network.rpc(fn_cb, "dragon.reset", "dragon.reset", params, true)
    return "dragon.reset"
end
...
-- 买血
function dragonBuyHp(fn_cb, params)
    Network.rpc(fn_cb, "dragon.buyHp", "dragon.buyHp", params, true)
    return "dragon.buyHp"
end

-- 贿赂
function dragonBribe(fn_cb, params)
    Network.rpc(fn_cb, "dragon.bribe", "dragon.bribe", params, true)
    return "dragon.bribe"
end

-- 买行动力
function dragonBuyAct(fn_cb, params)
    Network.rpc(fn_cb, "dragon.buyAct", "dragon.buyAct", params, true)
    return "dragon.buyAct"
end

-- 战斗
function dragonFight(fn_cb, params)
    Network.rpc(fn_cb, "dragon.fight", "dragon.fight", params, true)
    return "dragon.fight"
end

-- 获取阵型
function dragonGetUserBf(fn_cb, params)
    Network.rpc(fn_cb, "dragon.getUserBf", "dragon.getUserBf", params, true)
    return "dragon.getUserBf"
end

-- 一键答题
function dragonOnekey(fn_cb, params)
     Network.rpc(fn_cb, "dragon.onekey", "dragon.onekey", params, true)
    return "dragon.onekey"
end

-- 答题
function dragonAnswer(fn_cb, params)
    Network.rpc(fn_cb, "dragon.answer", "dragon.answer", params, true)
    return "dragon.answer"
end

-- 跳过
function dragonSkip(fn_cb, params)
     Network.rpc(fn_cb, "dragon.skip", "dragon.skip", params, true)
    return "dragon.skip"
end
...
function destoryDefence( fn_cb,params )
	-- body
	Network.rpc(fn_cb,"citywar.ruinCity","citywar.ruinCity",params,true)
	return "citywar.ruinCity"
end
---------------------------------
...
function repairDefence( fn_cb,params )
	-- body
	Network.rpc(fn_cb,"citywar.mendCity","citywar.mendCity",params,true)
	return "citywar.mendCity"
end
---------------------------------
