...
function createLevelRewardBtn(bglayer)
 	...
 	_levelRewardBtn:setAnchorPoint(ccp(0, 1))
 	_levelRewardBtn:setPosition(ccp(bgSize.width*0.03/MainScene.elementScale, bgSize.height*0.98/MainScene.elementScale))
