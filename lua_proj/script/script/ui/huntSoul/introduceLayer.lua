...
function getDesByCurId( id )
	...
	local textInfo = {}
	if(id == 1)then
		local str = CCRenderLabel:create(GetLocalizeStringBy("key_1290") , g_sFontName,23,1,ccc3(0x00,0x00,0x00),type_stroke)
		-- 文本宽度
	...
	elseif(id == 2)then
		local str = CCRenderLabel:create(GetLocalizeStringBy("key_2772") , g_sFontName,23,1,ccc3(0x00,0x00,0x00),type_stroke)
		-- 文本宽度
		textInfo.width = str:getContentSize().width+6
	...
	elseif(id == 3)then
		local str = CCRenderLabel:create(GetLocalizeStringBy("key_3220") , g_sFontName,23,1,ccc3(0x00,0x00,0x00),type_stroke)
		-- 文本宽度
		textInfo.width = str:getContentSize().width+6
		...
		textInfo[4] = { content=GetLocalizeStringBy("key_3023"), ntype="label", fontSize=23, color=ccc3(0xff, 0xff, 0xff), strokeSize=1,strokeColor=ccc3(0x00,0x00,0x00) }
	elseif(id == 4)then
		local str = CCRenderLabel:create(GetLocalizeStringBy("key_1496") , g_sFontName,23,1,ccc3(0x00,0x00,0x00),type_stroke)
		-- 文本宽度
		textInfo.width = str:getContentSize().width+6
		...
		local str = CCRenderLabel:create(GetLocalizeStringBy("key_2880") , g_sFontName,23,1,ccc3(0x00,0x00,0x00),type_stroke)
		-- 文本宽度
		textInfo.width = str:getContentSize().width+6
