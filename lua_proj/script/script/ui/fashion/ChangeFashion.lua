		...
		if(bagInfo and bagInfo.dress) then
			for k, itemInfo in pairs(bagInfo.dress) do
				...
				--添加 属性
					...
					print("the tag is  >>>>>>> ",item_template_id)
					-- local heroHtid = FashionLayer.getIconPath(tonumber(itemInfo.item_template_id), "changeModel")

					UserModel.setDressIdByPos(1, itemInfo.item_template_id)
