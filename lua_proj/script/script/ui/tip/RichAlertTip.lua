...
--[[
	...
	@return void
--]]
function showAlert(richInfo, confirmCBFunc, isNeedCancel, argsCB, confirmTitle, cancelTitle, closeCallbackFunc,isNeedKuoChong)
    ...
    richInfo.width = 460    -- 宽度
    richInfo.alignment = 2  -- 对齐方式  1 左对齐，2 居中， 3右对齐
    richInfo.labelDefaultFont = g_sFontName      -- 默认字体
    richInfo.labelDefaultColor = ccc3(0x78, 0x25, 0x00)  -- 默认字体颜色
    richInfo.labelDefaultSize = 25          -- 默认字体大小
	-- 描述
