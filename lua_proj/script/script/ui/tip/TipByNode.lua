...
--[[
	...
	@return :
--]]
function showLayer(p_comingNode,p_confirmCallBack,p_tipSize,p_touchPriority,p_zOrder)
	init()
    ...
    titleLabel:setPosition(ccp(alertBgSize.width*0.5, 290))
    alertBg:addChild(titleLabel)

	--要显示的话
	local addingNode = p_comingNode
	addingNode:setAnchorPoint(ccp(0.5,1))
	addingNode:setPosition(ccp(alertBgSize.width/2,250))
