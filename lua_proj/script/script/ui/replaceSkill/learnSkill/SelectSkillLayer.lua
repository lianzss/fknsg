...
function createCell( p_cellIndex )
	...
	local descTable = {
		...
		[3] = {cellData.starName, g_sFontPangWa, 18, ccc3(0xe4,0x00,0xff)}, 
...
function createMaxLevelRightUI( ... )
	...
	local label = CCRenderLabel:create("已达上限", g_sFontPangWa, 30, 1, ccc3(0x00,0x00,0x00), type_shadow)
