...
--[[
	...
	@ret  :	按钮
--]]
function createScale9MenuItem(p_normalImagePath, p_highlightImagePath, p_disableImagePath, p_btnSize, p_labelStr, p_fontSize, p_fontColor, p_fontType)
	...
	btnData[2] = {p_highlightImagePath, p_fontSize*0.9, p_fontColor}
	...
	for k,v in ipairs(btnData) do
		...
		label:setPosition(p_btnSize.width*0.5,p_btnSize.height*0.5)
...
function createAttributeBarFourSprite(p_returnType)
	...
	-- 银币
	local silverLabel = CCLabelTTF:create(UserModel.getSilverNumber(), g_sFontName, 20)
