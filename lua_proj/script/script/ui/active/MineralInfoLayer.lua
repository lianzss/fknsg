...
--]]
	...
	descLabel_1_node:setPosition(ccp(descSprite:getContentSize().width * 0.5, 50))
    ...
    if _curMineralInfo.domain_type == "3" then
        ...
        descLabel_2_node:setPosition(ccp(descSprite:getContentSize().width * 0.5, 15))
