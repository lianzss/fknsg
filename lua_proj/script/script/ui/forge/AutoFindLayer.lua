...
function autoCallback()
    ...
    AlertTip.showAlert(string.format(GetLocalizeStringBy("key_8222"), _gold_count, _act_count), autoFind, true, nil, GetLocalizeStringBy("key_8129"))
    
    --[[
    local data = {}
    data.act = _act_count
    data.gold = _gold_count
    data.floor_index = _selected_floor_end_index
    data.award_level = _selected_box_index
    require "script/ui/forge/AutoFindTipLayer"
    AutoFindTipLayer.show(data)
    --]]
end
