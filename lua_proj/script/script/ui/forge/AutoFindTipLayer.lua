...
function loadAwardTip()
    ...
    local get_award_title_label = CCRenderLabel:create("获得奖励：", g_sFontPangWa, 24, 1, ccc3(0x00,0x00,0x00), type_shadow)
    ...
    local get_award_1_label = CCRenderLabel:create("1.每层 150 点额外奖励积分；", g_sFontName, 18, 1, ccc3(0x00,0x00,0x00), type_shadow)
    ...
    local get_award_1_label = CCRenderLabel:create("2.随机橙装材料和图纸奖励；", g_sFontName, 18, 1, ccc3(0x00,0x00,0x00), type_shadow)
    bg:addChild(get_award_1_label)
    get_award_1_label:setColor(ccc3(0xff, 0xe4, 0x00))
    get_award_1_label:setAnchorPoint(ccp(0, 0.5))
    get_award_1_label:setPosition(ccp(103, 25))
    
    local tip = CCRenderLabel:create("提示：探宝结束将进入下一层入口或终点位置", g_sFontName, 18, 1, ccc3(0x00,0x00,0x00), type_shadow)
...
function loadMenu()
    ...
    local auto_btn = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(200, 73), "自动探宝",ccc3(0xfe, 0xdb, 0x1c),35,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
    ...
    local cancel_btn = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(200, 73), "取消选择",ccc3(0xfe, 0xdb, 0x1c),35,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
