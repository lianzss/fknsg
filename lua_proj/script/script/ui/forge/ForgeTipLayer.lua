...
-- disData:要铸造的装备信息
-- yesCallFun:确定按钮回调
function showTipLayer( p_srcData, p_disData, sender, p_yesCallFun )
	_sender = sender
...
-- 第一行
    ...
    -- 消耗的装备名字
   	local srcNameColor = HeroPublicLua.getCCColorByStarLevel(p_srcData.itemDesc.quality)
    ...
    -- 铸造出装备的名字
    local desNameColor = HeroPublicLua.getCCColorByStarLevel(p_disData.quality)
