...
function createLayer( )
	...
	-- -- 休息前一晚23点发奖
	-- local tableDay = {GetLocalizeStringBy("key_1557"),"一",GetLocalizeStringBy("key_2665"),GetLocalizeStringBy("key_2579"),GetLocalizeStringBy("key_1504"),GetLocalizeStringBy("key_2645"),"六"}
	-- local dateStr = nil
