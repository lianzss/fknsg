...
function createSprite( hardLevel, strongholdInfo, curBaseStars, defeat_num )
	...
	if(distance>1)then
		...
		-- 战斗按钮
		local fightBtn = LuaCC.create9ScaleMenuItem("images/common/btn/btn_red2_n.png","images/common/btn/btn_red2_h.png",CCSizeMake(119, 83),GetLocalizeStringBy("key_2565"),ccc3(0xfe, 0xdb, 0x1c),30,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
	    ...
	    if(distance <= 0)then
	    	...
	    	elseif(tonumber(defeat_num)>0)then
	    		-- 战10按钮
				local fight10Btn = LuaCC.create9ScaleMenuItem("images/common/btn/btn_blue2_n.png","images/common/btn/btn_blue2_h.png",CCSizeMake(125, 83),GetLocalizeStringBy("key_1787") .. defeat_num .. GetLocalizeStringBy("key_3010"),ccc3(0xfe, 0xdb, 0x1c),29,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
				fight10Btn:setAnchorPoint(ccp(0.5, 0.5))
				fight10Btn:setPosition(ccp(350, 85))
