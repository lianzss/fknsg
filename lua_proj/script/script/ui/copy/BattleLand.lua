...
function create(cityId,dictData)
	...
	defSprite:setPosition(ccp(bg_sprite_up:getContentSize().width-defSprite:getContentSize().width*0.6,bg_sprite_up:getContentSize().height*0.6))
	bg_sprite_up:addChild(defSprite)

	--攻方
	attSprite = CCSprite:create(IMG_PATH.."attPoint.png")
	attSprite:setAnchorPoint(ccp(0.5,0.5))
	attSprite:setPosition(ccp(attSprite:getContentSize().width*0.6,bg_sprite_up:getContentSize().height*0.6))
	...
	arrayMenuItem:setPosition(ccp(layerSize.width * 0.627-2*g_fElementScaleRatio, layerSize.height - (bg_sprite_up:getContentSize().height+60) * g_fScaleX))
