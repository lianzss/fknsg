...
function show( item_id , parent_tag)
	init()
...
function createCardInfo( ... )
	...
	local cardSprite = EquipCardSprite.createSprite(nil, itemId, t_equip_score)
...
function createFixedMenu( ... )
	...
	local  fixedButton1 		= LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(195,73),GetLocalizeStringBy("key_2487"),ccc3(255,222,0))
	...
	local fixedButton5 		= LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(195,73),GetLocalizeStringBy("key_2493"),ccc3(255,222,0))
	...
	local fixedButton10 		= LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(195,73),GetLocalizeStringBy("key_1803"),ccc3(255,222,0))
...
function updateEquipPotentiality( ... )
	...
	local nameColor = HeroPublicLua.getCCColorByStarLevel(potentInfo.desc.quality)
...
function closeCallback( tag ,sender )
	...
	local offsetPoint 	= BagLayer.getLastOffset()
	if(tolua.cast(offsetPoint ,"ccp") ~= nil) then
