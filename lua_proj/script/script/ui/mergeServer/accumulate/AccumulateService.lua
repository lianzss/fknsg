...
function getLoginReward(p_index,p_callback)
	local getLoginRewardCallBack = function(cbFlag,dictData,bRet)
		...
		if cbFlag == "mergeserver.getLoginReward" then
			p_callback()
		end
	end
	...
	Network.rpc(getLoginRewardCallBack,"mergeserver.getLoginReward","mergeserver.getLoginReward",arg,true)
end
...
function getRechargeReward(p_index,p_callback)
	local getRechargeRewardCallBack = function(cbFlag,dictData,bRet)
		...
		if cbFlag == "mergeserver.getRechargeReward" then
			p_callback()
		end
	end
	...
	Network.rpc(getRechargeRewardCallBack, "mergeserver.getRechargeReward","mergeserver.getRechargeReward", arg, true)
end