...
function create()
	...
	if(recentServerList ~= nil) then
		...
		local ow, oh = scrollView:getContentSize().width*0.5 , 80
...
function createServerButton( serverInfo )
	...
	serverLabelNode:setAnchorPoint(ccp(0.5, 0.5))
	serverLabelNode:setPosition(ccp(serverButton:getContentSize().width/2, serverButton:getContentSize().height/2))
