...
function upRefresh(cbFlag, dictData, bRet)
    if(dictData.err=="ok" and dictData.ret~=nil)then
        ...
        if(nextAstrology==nil)then
            ...
            nextAstroLabel = CCRenderLabel:create(GetLocalizeStringBy("key_2719"), g_sFontName, 24, 2, ccc3( 0x00, 0x00, 0x00), type_stroke)
            ...
            nextAstroLabel = CCRenderLabel:create(GetLocalizeStringBy("key_1636") .. nextAstrology.limited_lv .. GetLocalizeStringBy("key_2701"), g_sFontName, 24, 2, ccc3( 0x00, 0x00, 0x00), type_stroke)
            nextAstroLabel:setColor(ccc3(0x36,0xff,0x00))
...
function showAstrologyRewardLayer(prize_level,currentStar,prize_step,new_reward,re_num,astro_num)
    ...
    upgradeButton = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(210,73),GetLocalizeStringBy("key_2949"),ccc3(255,222,0))
    ...
    refreshButton = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(210,73),"",ccc3(255,222,0))
    refreshButton:setAnchorPoint(ccp(0.5,0.5))
    refreshButton:setPosition(ccp(m_layerSize.width*0.25,m_layerSize.height*0.11))
    ...
    local drawPrizeButton = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(210,73),GetLocalizeStringBy("key_1874"),ccc3(255,222,0))
	...
	drawPrizeButton:registerScriptTapHandler(drawPrizeClick)
