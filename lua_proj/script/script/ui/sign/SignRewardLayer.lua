...
local function createSignLayer( )
	...
	--奖励的标题文本
	local labelTitle = CCRenderLabel:create(GetLocalizeStringBy("key_1254"), g_sFontPangWa,35,2,ccc3(0x0,0x00,0x0),type_stroke)
...
local function singBtnCallBack(  )
...
function createSingBtn(bglayer)
	...
	--_signItemImage:setAnchorPoint(ccp(0.2,0.2))
