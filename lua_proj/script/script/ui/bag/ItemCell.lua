...
function createItemCell( itemData, isSell, useActionFunc, iconFuncDelegate)
	...
	-- 数量
	local numberLabel = CCRenderLabel:create(GetLocalizeStringBy("key_1147") .. itemData.item_num , g_sFontName, 21, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
	...
	local nameLabel = CCRenderLabel:create(itemData.itemDesc.name, g_sFontName, 28, 2, ccc3( 0x00, 0x00, 0x00), type_stroke)
