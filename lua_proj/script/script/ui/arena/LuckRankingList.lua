...
function createLuckRankingLayer( ... )
	...
	local titleLabel = LuaCCLabel.createShadowLabel(GetLocalizeStringBy("key_3319"), g_sFontPangWa, 34)
    ...
    local insetRect = CCRectMake(30, 30, 15, 10)
 	local second_bg = CCScale9Sprite:create(ArenaLayer.COMMON_PATH .. "bg/bg_ng_attr.png", fullRect, insetRect)
    ...
    local insetRect = CCRectMake(25, 25, 20, 20)
 	local last_bg = CCScale9Sprite:create(ArenaLayer.COMMON_PATH .. "bg/astro_btnbg.png", fullRect, insetRect)
	...
	local last_title_bg = CCScale9Sprite:create(ArenaLayer.COMMON_PATH .. "astro_labelbg.png", fullRect, insetRect)
	...
	-- 标题字体
	local last_title_font =  LuaCCLabel.createShadowLabel(GetLocalizeStringBy("key_2443"), g_sFontPangWa, 24)
    ...
    for i=1,10 do
      	...
      	if( math.floor(i%2) == 1 )then
      		...
      		local last_font_bg = CCScale9Sprite:create(ArenaLayer.IMG_PATH .. "lucknamebg_qian.png", fullRect, insetRect)
      	...
      	if( math.floor(i%2) == 0 )then
      		local fullRect = CCRectMake(0, 0, 106, 39)
      		local insetRect = CCRectMake(25, 15, 10, 10)
      		local last_font_bg = CCScale9Sprite:create(ArenaLayer.IMG_PATH .. "lucknamebg_shen.png", fullRect, insetRect)
    	  	last_font_bg:setContentSize(CCSizeMake(316,39))
    	  	last_font_bg:setAnchorPoint(ccp(0.5,1))
    	  	last_font_bg:setPosition(ccp(last_bg:getContentSize().width*0.5,last_bg:getContentSize().height-(i-1)*last_font_bg:getContentSize().height-59))
    	  	last_bg:addChild(last_font_bg,1,i)
    ...
    if(ArenaData.luckyListData.last ~= nil and ArenaData.tableCount(ArenaData.luckyListData.last) ~= 0 )then
  	...
  	local fullRect = CCRectMake(0, 0, 75, 75)
    local insetRect = CCRectMake(25, 25, 20, 20)
   	local cur_bg = CCScale9Sprite:create(ArenaLayer.COMMON_PATH .. "bg/astro_btnbg.png", fullRect, insetRect)
  	...
  	local fullRect = CCRectMake(0, 0, 75, 35)
    local insetRect = CCRectMake(25, 15, 20, 10)
  	local cur_title_bg = CCScale9Sprite:create(ArenaLayer.COMMON_PATH .. "astro_labelbg.png", fullRect, insetRect)
  	...
  	-- 标题字体
  	local cur_title_font =  LuaCCLabel.createShadowLabel(GetLocalizeStringBy("key_2752"), g_sFontPangWa, 24)
    ...
    for i=1,10 do
    	...
    	if( math.floor(i%2) == 1 )then
    		local fullRect = CCRectMake(0, 0, 106, 39)
    		local insetRect = CCRectMake(25, 15, 10, 10)
    		local cur_font_bg = CCScale9Sprite:create(ArenaLayer.IMG_PATH .. "lucknamebg_qian.png", fullRect, insetRect)
    	...
    	if( math.floor(i%2) == 0 )then
    		local fullRect = CCRectMake(0, 0, 106, 39)
    		local insetRect = CCRectMake(25, 15, 10, 10)
    		local cur_font_bg = CCScale9Sprite:create(ArenaLayer.IMG_PATH .. "lucknamebg_shen.png", fullRect, insetRect)
		  	cur_font_bg:setContentSize(CCSizeMake(232,39))
		  	cur_font_bg:setAnchorPoint(ccp(0.5,1))
		  	cur_font_bg:setPosition(ccp(cur_bg:getContentSize().width*0.5,cur_bg:getContentSize().height-(i-1)*cur_font_bg:getContentSize().height-59))
		  	cur_bg:addChild(cur_font_bg,1,i)
