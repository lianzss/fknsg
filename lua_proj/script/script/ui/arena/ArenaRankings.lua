...
function createArenaRankingsLayer( ... )
	...
	local luckMenuItem = CCMenuItemImage:create(ArenaLayer.COMMON_PATH .. "btn/btn_bg_n.png",ArenaLayer.COMMON_PATH .. "btn/btn_bg_h.png")
	...
	-- 幸运排名文字
	local luckFont = CCRenderLabel:create( GetLocalizeStringBy("key_3319") , g_sFontPangWa, 30, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
	...
	-- 上分界线
	local topSeparator = CCSprite:create(ArenaLayer.COMMON_PATH .."separator_top.png")
