...
require "script/ui/arena/PrestigeShop"

module("ArenaLayer", package.seeall)
-- 全局变量
COMMON_PATH = "images/common/"					    			-- 公用图片主路径
IMG_PATH = "images/arena/"					    				-- 竞技图片主路径
...
local refreshArenaGold = nil									-- 刷新金币函数
upDateStamina = nil												-- 耐力UI更新函数
...
function initArenaLayer( ... )
	...
	tabLayer:registerScriptTapHandler(function ( button,index )
        ...
        elseif (index == 2) then
            ...
            require "script/ui/arena/PrestigeShop"
            tabLayer:layerOfIndex(2):addChild( PrestigeShop.createPrestigeShopLayer() )
        end
	end)
