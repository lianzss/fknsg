...
local function buyAction( tag, itemBtn )
	...
	local maxLimitNum =  tonumber(goods_data.baseNum) - ArenaData.getBuyNumBy(goods_data.id)
...
function createCell( goods_data )
	...
	-- 价格
	local priceLabel = CCRenderLabel:create(GetLocalizeStringBy("key_2902"), g_sFontName, 30, 1, ccc3(0x00, 0x00, 0x00), type_stroke)
