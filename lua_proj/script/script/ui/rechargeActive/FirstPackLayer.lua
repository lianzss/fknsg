...
function createLayer(  )
	...
	-- 显示 pretty girl
	local prettySprite = CCSprite:create(IMG_PATH .. "pretty_girl.png")
	...
	local descBg =  CCScale9Sprite:create(IMG_PATH .."first_charge/charge_desc.png")
	descBg:setScale(MainScene.elementScale)
	-- descBg:setContentSize(CCSizeMake(320,227))
	descBg:setPosition(ccp(bgSize.width*279/640,bgSize.height*355/655))
	...
	rechargeBtn:setPosition(ccp(346/640*bgSize.width,235/655*bgSize.height))
