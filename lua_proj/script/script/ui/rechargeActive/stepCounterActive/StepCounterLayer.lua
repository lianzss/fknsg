...
function updateTimeFunc()
	...
	if( _tempCounts%1 == 0 )then
		--得到当前已走的步数
		local stepNum = StepCounterData.getStepNum()
...
function createUpperBg(p_middleHeight,p_redPosY)
	...
	node_3:setPosition(ccp(wideX,p_redPosY - p_middleHeight*165/655))
	...
	node_4:setPosition(ccp(wideX,p_redPosY - p_middleHeight*210/655))
	...
	node_5:setPosition(ccp(wideX,p_redPosY - p_middleHeight*250/655))
