...
function createBgUI()
	...
	--如果已领取
		...
		getRewardBtn = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_g.png","images/common/btn/btn1_g.png",CCSizeMake(200, 73),GetLocalizeStringBy("key_1369"),ccc3(0xff, 0xff, 0xff),35,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
	end
	getRewardBtn:setAnchorPoint(ccp(0.5,1))
	getRewardBtn:setPosition(ccp(_curRewardBgSprite:getContentSize().width/2,-5))
	_bgMenu:addChild(getRewardBtn,1,kMenuTag)
