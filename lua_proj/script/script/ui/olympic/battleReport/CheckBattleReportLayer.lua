...
function createBgUI()
    ...
    --整体战报按钮
    _wholeMenuItem = LuaCCMenuItem.createMenuItemOfRender2(image_n,image_h,rect_full_n,rect_inset_n,rect_full_h,rect_inset_h,btn_size_n,btn_size_h,GetLocalizeStringBy("zzh_1030"),text_color_n,text_color_h,font,font_size,strokeCor_n,strokeCor_h,stroke_size_n,stroke_size_h)
    ...
    --个人战报按钮
    _personalMenuItem = LuaCCMenuItem.createMenuItemOfRender2(image_n,image_h,rect_full_n,rect_inset_n,rect_full_h,rect_inset_h,btn_size_n,btn_size_h,GetLocalizeStringBy("zzh_1031"),text_color_n,text_color_h,font,font_size,strokeCor_n,strokeCor_h,stroke_size_n,stroke_size_h)
