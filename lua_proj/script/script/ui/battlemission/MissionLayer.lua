...
function createLeftNum(index)
    ...
    --右数字尾2
    local pRight2NumLabel = CCRenderLabel:create(_missionTable[index].num, g_sFontPangWa,21,1,ccc3( 0x00, 0x00, 0x00), type_stroke)
...
function goNow( tag,item )
    ...
    local  tab = string.split(des.completeConditions,",")
    require "script/ui/copy/CopyUtil.lua"
