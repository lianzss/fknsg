-- Filename: GoodResolveCell.lua
-- Author: zhang zihang
-- Date: 2014-2-11
-- Purpose: 该文件用于: 宝物炼化选择cell

module ("GoodResolveCell", package.seeall)
...
function createTreasCell( treasData, isSell)
    ...
    checkedBtn:registerScriptTapHandler(ResolveSelectLayer.checkedGoodAction)
...
--require "script/ui/recycle/EquipResolveCell"
	...
	local handler = LuaEventHandler:create(function(fn, table, a1, a2) 	--创建
		...
		elseif fn == "cellAtIndex" then
			...
			ResolveSelectLayer.updateGoodParentParam(a1,a2)
			r = a2
		...
		elseif (fn == "cellTouched") then
			...
			ResolveSelectLayer.fnHandlerOfGoodTouched(menuBtn_M,m_data)
		end
