-- Filename: EquipResolveCell.lua
-- Author: zhang zihang
-- Date: 2014-2-11
-- Purpose: 该文件用于: 装备炼化选择cell

module ("EquipResolveCell", package.seeall)
...
function createEquipCell( equipData, isSell)
    ...
    checkedBtn:registerScriptTapHandler(ResolveSelectLayer.checkedItemAction)
...
function createItemSellTableview(_tParentParam,layerWidth,_scrollview_height)
	...
	local handler = LuaEventHandler:create(function(fn, table, a1, a2) 	--创建
		...
		elseif fn == "cellAtIndex" then
			...
			ResolveSelectLayer.updateItemParentParam(a1,a2)
			r = a2
		...
		elseif (fn == "cellTouched") then
			...
			ResolveSelectLayer.fnHandlerOfItemTouched(menuBtn_M,m_data)
		end
