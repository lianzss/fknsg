...
function sendClick()
    ...
    if(talkEditBox:getText()~=nil and talkEditBox:getText()~="" )then
        ...
        local url = "http://mapifknsg.zuiyouxi.com/phone/question?"
        if(BTUtil:getDebugStatus()==true)then
            url = "http://124.205.151.82/phone/question?"
        end
...
function initSubmitView()
    ...
    m_chatsubmitLayer:setAnchorPoint(ccp(0,0))
    m_chatsubmitLayer:setPosition(ccp(0,0))
    ...
    submitBg:setPosition(ccp(30,110))
    ...
    submitLabel:setPosition(ccp(m_layerSize.width*0.17, m_layerSize.height*0.81))
    ...
    reviewLabel:setPosition(ccp(m_layerSize.width*0.425, m_layerSize.height*0.81))
	...
	counselLabel:setPosition(ccp(m_layerSize.width*0.25, m_layerSize.height*0.71))
    m_chatsubmitLayer:addChild(counselLabel)
    
    
	 bugButton = CCMenuItemImage:create(IMG_PATH .. "radio_n.png", IMG_PATH .. "radio_s.png")
	bugButton:setPosition(ccp(m_layerSize.width*0.39, m_layerSize.height*0.71))
	...
	bugLabel:setPosition(ccp(m_layerSize.width*0.45, m_layerSize.height*0.71))
    m_chatsubmitLayer:addChild(bugLabel)
    
    
	 complaintButton = CCMenuItemImage:create(IMG_PATH .. "radio_n.png", IMG_PATH .. "radio_s.png")
	complaintButton:setPosition(ccp(m_layerSize.width*0.59, m_layerSize.height*0.71))
	...
	complaintLabel:setPosition(ccp(m_layerSize.width*0.65, m_layerSize.height*0.71))
    m_chatsubmitLayer:addChild(complaintLabel)
    
    
	 adviseButton = CCMenuItemImage:create(IMG_PATH .. "radio_n.png", IMG_PATH .. "radio_s.png")
	adviseButton:setPosition(ccp(m_layerSize.width*0.79, m_layerSize.height*0.71))
	...
	adviseLabel:setPosition(ccp(m_layerSize.width*0.85, m_layerSize.height*0.71))
    ...
    contentDescLabel:setPosition(ccp(m_layerSize.width*0.09, m_layerSize.height*0.63))
	...
	talkEditBox:setPosition(ccp(m_layerSize.width*0.19, m_layerSize.height*0.47))
...
function initReviewView()
    ...
    m_chatreviewLayer:setAnchorPoint(ccp(0,0))
    m_chatreviewLayer:setPosition(ccp(0,0))
    ...
    reviewBg:setPosition(ccp(30,110))
    ...
    sendButton:setAnchorPoint(ccp(0.5,0.5))
    sendButton:setPosition(ccp(m_layerSize.width*0.5,m_layerSize.height*0.1))
	...
	scrollView:setPosition(ccp(m_layerSize.width*0.05,m_layerSize.height*0.17))
...
function getChatGmLayer()
    ...
    m_chatGmLayerBg:setAnchorPoint(ccp(0,0))
