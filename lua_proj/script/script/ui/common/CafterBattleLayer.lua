...
-- Author: Li Cong 
-- Date: 13-10-8 
-- Purpose: function description of module  ，邮件战报，
...
-- flopData:掉落翻牌数据
-- CallFun: 自定义确定按钮后回调
function createAfterBattleLayer( appraisal, enemyUid, enemyName, enemyUtid, enemyFightData, honorData, expData, flopData, CallFun ,fightStr)
    -- 初始化
    init()
    ...
    -- 创建V/S
    local vs_bg = CCSprite:create("images/arena/vs_bg.png")
