...
function initGetStaminaLayer( ... )
    ...
    local receiveAllItem = LuaCC.create9ScaleMenuItem("images/common/btn/btn1_d.png","images/common/btn/btn1_n.png",CCSizeMake(300, 73),GetLocalizeStringBy("key_1194"),ccc3(0xfe, 0xdb, 0x1c),35,g_sFontPangWa,1, ccc3(0x00, 0x00, 0x00))
