...
function createCell( tCellValue )
	...
	name_bg:setContentSize(CCSizeMake(244,36))
	...
	if(status == 1)then
	    ...
	    online_font:setPosition(ccp(268,cell_bg:getContentSize().height-16))
    ...
    elseif(status == 2)then
	    ...
	    offline_font:setPosition(ccp(268,cell_bg:getContentSize().height-16))
