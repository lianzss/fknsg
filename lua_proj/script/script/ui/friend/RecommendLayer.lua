...
function initRecommendLayer( ... )
	...
	-- 阵容字体
	local item_font = CCRenderLabel:create( GetLocalizeStringBy("key_2908") , g_sFontPangWa, 30, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
    item_font:setColor(ccc3(0xfe, 0xdb, 0x1c))
    item_font:setPosition(ccp(24,searchMenuItem:getContentSize().height-11))
