...
function createCell( tCellValue )
	...
	name_bg:setContentSize(CCSizeMake(281,36))
    ...
    name:setPosition(ccp(127,name_bg:getContentSize().height-6))
	...
	-- 邀请字体
	local item_font = CCRenderLabel:create( GetLocalizeStringBy("key_3263"), g_sFontPangWa, 38, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
    item_font:setColor(ccc3(0xfe, 0xdb, 0x1c))
    item_font:setPosition(ccp(21,inviteMenuItem:getContentSize().height-15))
