...
function createCell( tCellValue,lineNum)
    ...
    if(tonumber(_curTag) == tonumber(_tagFightForce))then -----个人战斗力
        ...
        if(tCellValue.guild_name ~= nil )then
            ...
            local guildname = CCRenderLabel:create("("..guildStr..")" , g_sFontPangWa, 25, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
            guildname:setColor(ccc3(0xff, 0xf6, 0x00))
            guildname:setAnchorPoint(ccp(0.5,0))
            guildname:setPosition(ccp(331,10))
    ...
    elseif(tonumber(_curTag) == tonumber(_tagGuild))then ---------军团战斗力
        ...
        local guild_name = CCRenderLabel:create( str_guild_name, g_sFontPangWa, 24, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
        ...
        local leader_name = CCRenderLabel:create( str_leader_name, g_sFontPangWa, 24, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
