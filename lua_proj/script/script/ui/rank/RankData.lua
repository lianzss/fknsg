...
function getUserRankGuildInfo( ... )
    ...
    -- print_t(GuildDataCache.getMineSigleGuildInfo())
    -- print("++++++++++++")
    ...
    -- print("用户军团id",user_guild_id)

    -- ---------------当前用户没有加入军团
    -- if (user_guild_id <= 0 )then
    --     print("用户没加入军团")
    --     user_guild_rank = GetLocalizeStringBy("key_1554")--无
    ...
    --     ---------------得到排名列表数据
    --     m_rankTabViewInfo = getRankListData() or {}
