...
--[[
 	...
 	这样则无法遍历day = {"一",GetLocalizeStringBy("key_2665"),GetLocalizeStringBy("key_2579"),GetLocalizeStringBy("key_1504"),GetLocalizeStringBy("key_2645"),"六",GetLocalizeStringBy("key_1557")}这种配置数组
--]]
function getSendRewardTimeString( ... )
	...
	local day = {"一",GetLocalizeStringBy("key_2665"),GetLocalizeStringBy("key_2579"),GetLocalizeStringBy("key_1504"),GetLocalizeStringBy("key_2645"),"六",GetLocalizeStringBy("key_1557")}
...
function getTimeStrByNum( num )
	...
	local zhou = {GetLocalizeStringBy("key_1557"),"一",GetLocalizeStringBy("key_2665"),GetLocalizeStringBy("key_2579"),GetLocalizeStringBy("key_1504"),GetLocalizeStringBy("key_2645"),"六"}
