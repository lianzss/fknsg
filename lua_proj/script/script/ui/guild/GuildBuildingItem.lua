...
touchSizeDict[Tag_Guanxintai]  	= CCSizeMake(150, 180)
...
buildingPngArr[Tag_Guanxintai] 	= {png_n="images/guild/building/building_gray.png", png_h="images/guild/building/building_gray.png"}
