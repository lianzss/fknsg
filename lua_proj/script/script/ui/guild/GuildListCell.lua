...
function createCell( tCellValue, isHaveGuild )
    ...
    guild_name:setAnchorPoint(ccp(0.5,1))
    guild_name:setPosition(ccp(273,cell_bg:getContentSize().height-5))
   	cell_bg:addChild(guild_name)
	-- 军团等级
	local lv_sprite = CCSprite:create("images/common/lv.png")
	lv_sprite:setAnchorPoint(ccp(0,1))
	lv_sprite:setPosition(ccp(368,cell_bg:getContentSize().height-14))
	cell_bg:addChild(lv_sprite)
	-- local guild_lvFont = CCRenderLabel:create( "Lv.", g_sFontName, 21, 1, ccc3( 0x00, 0x00, 0x00), type_stroke)
    -- guild_lvFont:setColor(ccc3( 0xff, 0xf6, 0x00))
    -- guild_lvFont:setAnchorPoint(ccp(0,1))
    -- guild_lvFont:setPosition(ccp(368,cell_bg:getContentSize().height-13))
   	-- cell_bg:addChild(guild_lvFont)
    ...
    lv_data:setPosition(ccp(lv_sprite:getPositionX()+lv_sprite:getContentSize().width+5,cell_bg:getContentSize().height-13))
