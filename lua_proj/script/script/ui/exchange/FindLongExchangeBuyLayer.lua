...
function buySuccessful()
	...
	strSp:setString(GetLocalizeStringBy("zz_3").. remainExchangeNum ..GetLocalizeStringBy("zz_4"))

	print("removeCellAtIndex outside ...")
	if remainExchangeNum < 1 then
		print("removeCellAtIndex inside ...")
		local tableView = tolua.cast(FindLongExchangeLayer.getExchangeInfoLayer():getChildByTag(100),"LuaTableView")
