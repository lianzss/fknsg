...
function getOrderUrl(coins,payType,amount)
	...
	return "http://mapifknsg.zuiyouxi.com/phone/exchange?pid=" .. loginInfoTable.uid .. "&group=" .. myGroup .. "&orderAmount=" .. coins .. "&action=getorder".. Platform.getUrlParam() .."&payType="..payType.. "&payAmount=".. amount .."&time=" .. BTUtil:getSvrTimeInterval() 
end
...
function getOrderUrl_debug(coins,payType,amount)
	...
	print("groupId2",myGroup)
	return "http://124.205.151.82/phone/exchange?pid=" .. loginInfoTable.uid .. "&group=" .. myGroup .. "&orderAmount=" .. coins .. "&action=getorder".. Platform.getUrlParam() .."&payType="..payType.. "&payAmount=".. amount .."&time=" .. BTUtil:getSvrTimeInterval() 
end