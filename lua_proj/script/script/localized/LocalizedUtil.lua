...
function InitLocalized( ... )
    ...
    if(NSBundleInfo and string.checkScriptVersion~=nil and string.checkScriptVersion(NSBundleInfo:getAppVersion(), "2.0.0") >= 0 )then
...
function createMultiColorLabelSprite( multiTextInfo, maxWidth, multiLineTextAlignment )
    ...
    for rowIndex, labelArr in pairs(rowElements) do
        local rowY = maxRowHeight - rowIndex * maxRowHeight
