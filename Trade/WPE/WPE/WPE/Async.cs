            ...
            private static bool BeforeInvoke(AsyncRes res)
            {
                ...
                if (res.RMode != ReenteranceMode.Allow)
                {
                    ...
                    lock (methodLocks)
                    {
                        ...
                        {
                            if (!System.Threading.Monitor.TryEnter(methodLocks[res.Method]))
                            {
                        ...
                        else
                        {
                            ...
                            System.Threading.Monitor.Enter(methodLocks[res.Method]);
                        }
            ...
            private static void FinishInvoke(AsyncRes res)
            {
                ...
                if (res.RMode != ReenteranceMode.Allow)
                {
                    ...
                    try
                    {
                        if (methodLocks.ContainsKey(res.Method))
                        {
                            System.Threading.Monitor.Exit(methodLocks[res.Method]);
                        }
                    }
                    catch (Exception ex)
                    {
